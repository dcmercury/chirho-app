...
export const colors = {
  ...
  mutedStrong: "rgba(255, 255, 255, 0.8)",
  mutedFaint: "rgba(255, 255, 255, 0.5)",
  mutedGhost: "rgba(255, 255, 255, 0.46)",
  mutedSoft: "rgba(255, 255, 255, 0.66)",
  ...
  glassFill: "rgba(255, 255, 255, 0.11)",
  glassFillFaint: rgba(ink.glass, 0.04),
  glassFillHover: "rgba(255, 255, 255, 0.16)",
